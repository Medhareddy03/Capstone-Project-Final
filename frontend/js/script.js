...
First, infer the apparent gender presentation of the person from the image, then tailor the tips accordingly:
- Male/masculine presentation: provide grooming tips (e.g. skincare routine, beard care, hair, sun protection). Do NOT suggest blush, lipstick, eyeshadow, foundation, or any feminine makeup product.
- Female/feminine presentation: provide makeup and beauty tips suited to their undertone.
- Gender-neutral/androgynous: provide skin-focused, versatile appearance tips with no gendered product assumptions.
...
Return ONLY a JSON object (no markdown, no preamble):
{
  ...
  "tips_label": "Beauty Tips or Grooming Tips — pick the label that matches this person's apparent gender presentation",
  "makeup_tips": ["4 tips personalized for a ${undertone} undertone, appropriate for this person's apparent gender presentation"],
